    ...
    class MainWindow(QMainWindow, Ui_MainWindow):
        ...
        def update_tablewidget(self, item, table2):
            ...
            try:
                if 0 < col < 8:
                    ...
                    dUr_x = np.around(dUr_x, decimals=6)
        ...
        def generate_excel(self):
            ...
            if self.check_aci.isChecked():
                ...
                self.creat_excelAC(ws4, self.check_aci, self.ilACI.value(),
            ...
            if self.check_acv.isChecked():
                ...
                self.creat_excelAC(ws2, self.check_acv, self.ilACV.value(),
        ...
        def creat_excelAC(self, ws, checked, ile, zakres1, zakres2):
            ...
            if checked.isChecked():
                ...
                if checked != self.check_r:
                        ...
                        try:
                            if (row == 0 + x) and (ile <= 4) and (zakres2 / 100 >= 1):
                                ...
                                if checked == self.check_dcv or checked == self.check_acv:
                                    ...
                                    ws.cell(row + 6, 2, 'A')
                                ws.merge_cells(f"B{10 + x}:F{10 + x}")
                            elif (row == 7 + x) and (ile == 6) and (zakres2 / 100 >= 1):
                                if checked == self.check_dcv or checked == self.check_acv:
                                    ws.cell(row + 6, 2, 'V')
                                elif checked == self.check_dci or checked == self.check_aci:
                                    ws.cell(row + 6, 2, 'A')
                                ws.merge_cells(f"B{13 + x}:F{13 + x}")
                                ...
                                if checked == self.check_dcv or checked == self.check_acv:
                                    ...
                                    ws.cell(row + 6, 2, 'A')
                                ws.merge_cells(f"B{20 + x}:F{20 + x}")
                            elif (row == 0 + x) and (ile <= 2) and (zakres2 / 10 < 1) and (zakres2 > 1):
                                if checked == self.check_dcv or checked == self.check_acv:
                                    ws.cell(row + 6, 2, 'V')
                                elif checked == self.check_dci or checked == self.check_aci:
                                ...
                                if checked == self.check_dcv or checked == self.check_acv:
                                    ...
                                    ws.cell(row + 6, 2, 'A')
                                ws.merge_cells(f"B{23 + x}:F{23 + x}") #git?
                    ...
                    elif ile == 3 and zakres2 / 10 < 1 < zakres2:
                        end = 2
                    else:
                        end = 0
